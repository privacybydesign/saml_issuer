...
<head>
	...
	<title>SURFconext attributes</title>
</head>
<body>
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-md-8 col-lg-6 col-md-offset-2 col-lg-offset-3">
				<h2>Available SURFconext attributes</h2>

				<div id="alert_box"></div>

				<p>The attributes below can be added
				to your IRMA app.</p>
				<table class="table">
					<tr>
					...
					<tr>
						<th scope="row">Type (student/employee)</th>
						<td><?= $authenticated_user->type ?></td>
					</tr>
					<tr>
						<th scope="row">Unique identifier</th>
				...
				<p>Click here to add this attributes
				to your IRMA app</p>
