...
$config = [
     ...
     * reverse proxy).
     */
    // this evaluates to "https://HOST_NAME/simplesaml/"
    'baseurlpath' => rtrim((strpos(getenv('HOST_NAME'), 'https://') === 0 ? getenv('HOST_NAME') : 'https://' . getenv('HOST_NAME')), '/') . '/simplesaml/',
    ...
    'application' => [
         ...
         */
        'baseURL' => rtrim((strpos(getenv('HOST_NAME'), 'https://') === 0 ? getenv('HOST_NAME') : 'https://' . getenv('HOST_NAME')), '/'),
    ],
    ...
    */
     ...
     */
    'session.cookie.secure' => true, // SET TO TRUE FOR PRODUCTION
